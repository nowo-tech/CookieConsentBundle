...
final class Version20250615200000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $translationTable = 'demo_tailwind_dashboard_cookie_config_translation';
        ...
        if (!$this->tableExists('demo_tailwind_dashboard_cookie_definition')) {
            $this->addSql('CREATE TABLE demo_tailwind_dashboard_cookie_definition (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, config_id INTEGER NOT NULL, name VARCHAR(120) NOT NULL, duration VARCHAR(60) NOT NULL, category VARCHAR(40) NOT NULL, type VARCHAR(20) NOT NULL, sort_order INTEGER DEFAULT 0 NOT NULL, CONSTRAINT FK_DEMO_TAILWIND_COOKIE_DEFINITION_CONFIG FOREIGN KEY (config_id) REFERENCES demo_tailwind_dashboard_cookie_config (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
            $this->addSql('CREATE UNIQUE INDEX uniq_cookie_definition_config_name ON demo_tailwind_dashboard_cookie_definition (config_id, name)');
            $this->addSql('CREATE TABLE demo_tailwind_dashboard_cookie_definition_translation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, definition_id INTEGER NOT NULL, locale VARCHAR(10) NOT NULL, provider VARCHAR(120) NOT NULL, purpose CLOB NOT NULL, CONSTRAINT FK_DEMO_TAILWIND_COOKIE_DEFINITION_TRANSLATION FOREIGN KEY (definition_id) REFERENCES demo_tailwind_dashboard_cookie_definition (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
            $this->addSql('CREATE UNIQUE INDEX uniq_cookie_definition_translation_locale ON demo_tailwind_dashboard_cookie_definition_translation (definition_id, locale)');
        }
    }
