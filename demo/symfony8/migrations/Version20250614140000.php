...
final class Version20250614140000 extends AbstractMigration
{
    ...
    {
        $this->addSql("ALTER TABLE demo_nowo_cookie_consent_config ADD COLUMN auto_show_route_mode VARCHAR(20) DEFAULT 'all' NOT NULL");
        $this->addSql("ALTER TABLE demo_nowo_cookie_consent_config ADD COLUMN auto_show_routes CLOB NOT NULL DEFAULT '[]'");
        $this->addSql('ALTER TABLE demo_nowo_cookie_consent_config ADD COLUMN name VARCHAR(100) DEFAULT NULL');
        $this->addSql("ALTER TABLE demo_nowo_cookie_consent_config ADD COLUMN route_patterns CLOB NOT NULL DEFAULT '[]'");
        $this->addSql('ALTER TABLE demo_nowo_cookie_consent_config ADD COLUMN priority INTEGER DEFAULT 0 NOT NULL');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('CREATE TABLE __temp_demo_nowo_cookie_consent_config AS SELECT id, enabled, is_default, auto_show, revision, manage_script_tags, auto_clear_cookies, hide_from_bots, disable_page_interaction, lazy_html_generation, consent_modal_layout, consent_modal_variant, consent_modal_position_y, consent_modal_position_x, consent_modal_equal_weight_buttons, consent_modal_flip_buttons, preferences_modal_layout, preferences_modal_variant, preferences_modal_position_y, preferences_modal_position_x, preferences_modal_equal_weight_buttons, preferences_modal_flip_buttons FROM demo_nowo_cookie_consent_config');
