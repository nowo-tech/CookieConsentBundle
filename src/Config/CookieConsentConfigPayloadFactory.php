            ...
            'data' => [
                ...
                'guiOptions' => [
                    'consentModal' => [
                        ...
                        'position'           => $config?->getConsentModalPosition() ?? 'bottom left',
                        'equalWeightButtons' => $config?->isConsentModalEqualWeightButtons() ?? true,
                    ...
                    'preferencesModal' => [
                        ...
                        'position'           => $config?->getPreferencesModalPosition() ?? 'bottom left',
                        'equalWeightButtons' => $config?->isPreferencesModalEqualWeightButtons() ?? true,
