...
PHP coverage target is ~100% (currently ~100%; see [Release](docs/RELEASE.md)); exclusions must be justified in `phpunit.xml.dist`.

## Found this useful?

If this bundle helps your project, consider starring the repository on [GitHub](https://github.com/nowo-tech/cookie-consent-bundle) or installing from [Packagist](https://packagist.org/packages/nowo-tech/cookie-consent-bundle).
